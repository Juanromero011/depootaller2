...
public class SandboxArreglos
{
    ...
    public void eliminarEntero( int valor )
    {
        ...
        int index = 0;
        for (int num : arregloEnteros) {
            if (num != valor) nuevoArreglo[index++] = num;
        }
        arregloEnteros = nuevoArreglo;
    }
    ...
    public void eliminarCadena( String cadena )
    {
        ...
        for (String str : arregloCadenas) {
            if (!str.equals(cadena)) contador++;
        }
        String[] nuevoArreglo = new String[contador];
        int index = 0;
        for (String str : arregloCadenas) {
            if (!str.equals(cadena)) nuevoArreglo[index++] = str;
        }
        arregloCadenas = nuevoArreglo;
    }
    ...
    public void eliminarEnteroPorPosicion( int posicion )
    {
        ...
        int j = 0;
        for (int i = 0; i < arregloEnteros.length; i++) {
            if (i != posicion) nuevoArreglo[j++] = arregloEnteros[i];
        }
        arregloEnteros = nuevoArreglo;
    }
